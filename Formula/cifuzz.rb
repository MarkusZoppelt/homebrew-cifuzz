class Cifuzz < Formula
  ...
  url "https://github.com/CodeIntelligenceTesting/cifuzz/archive/refs/tags/v0.34.0.tar.gz"
  sha256 "0de8c0d9022cdfc8a3e691044cd1607ec5ad5c010bd468b5165a82c1165d8b98"
  license "Apache-2.0"
  ...
  def install
    system "go", "run", "tools/builder/builder.go", "--version", "0.34.0"
